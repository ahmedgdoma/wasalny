...
define("EW_PROJECT_NAME", "project", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{13D25F72-8F7B-4FA3-9328-7C3143C406A5}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'YkacckVkwEPr4AGJ', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/project.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'arenaegy_tawsel', TRUE);
define("EW_CONN_PASS", '!4#rP(Lt=l]L', TRUE);
define("EW_CONN_DB", 'arenaegy_tawsela', TRUE);
