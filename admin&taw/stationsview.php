...
$stations_view = NULL; // Initialize page object first

class cstations_view extends cstations {
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "stationslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "stationslist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "stationslist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($stations_view)) $stations_view = new cstations_view();

// Page init
$stations_view->Page_Init();

// Page main
$stations_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$stations_view->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var stations_view = new ew_Page("stations_view");
stations_view.PageID = "view"; // Page ID
var EW_PAGE_ID = stations_view.PageID; // For backward compatibility

// Form object
var fstationsview = new ew_Form("fstationsview");

// Form_CustomValidate event
fstationsview.Form_CustomValidate = 
...
fstationsview.ValidateRequired = true;
<?php } else { ?>
fstationsview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fstationsview.Lists["x_travel_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_travel_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $stations_view->ExportOptions->Render("body") ?>
<?php if (!$stations_view->ExportOptions->UseDropDownButton) { ?>
</div>
<div class="ewViewOtherOptions">
<?php } ?>
<?php
	foreach ($stations_view->OtherOptions as &$option)
		$option->Render("body");
?>
</div>
<?php $stations_view->ShowPageHeader(); ?>
<?php
$stations_view->ShowMessage();
?>
<form name="fstationsview" id="fstationsview" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="stations">
<table class="ewGrid"><tr><td>
<table id="tbl_stationsview" class="table table-bordered table-striped">
<?php if ($stations->id->Visible) { // id ?>
	<tr id="r_id">
		<td><span id="elh_stations_id"><?php echo $stations->id->FldCaption() ?></span></td>
		<td<?php echo $stations->id->CellAttributes() ?>>
<span id="el_stations_id" class="control-group">
<span<?php echo $stations->id->ViewAttributes() ?>>
<?php echo $stations->id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($stations->travel_id->Visible) { // travel_id ?>
	<tr id="r_travel_id">
		<td><span id="elh_stations_travel_id"><?php echo $stations->travel_id->FldCaption() ?></span></td>
...
<?php echo $stations->travel_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($stations->station_name->Visible) { // station_name ?>
	<tr id="r_station_name">
		<td><span id="elh_stations_station_name"><?php echo $stations->station_name->FldCaption() ?></span></td>
...
<?php echo $stations->station_name->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($stations->longitude->Visible) { // longitude ?>
	<tr id="r_longitude">
		<td><span id="elh_stations_longitude"><?php echo $stations->longitude->FldCaption() ?></span></td>
...
<?php echo $stations->longitude->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($stations->latitude->Visible) { // latitude ?>
	<tr id="r_latitude">
		<td><span id="elh_stations_latitude"><?php echo $stations->latitude->FldCaption() ?></span></td>
...
<?php echo $stations->latitude->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($stations->created_at->Visible) { // created_at ?>
	<tr id="r_created_at">
		<td><span id="elh_stations_created_at"><?php echo $stations->created_at->FldCaption() ?></span></td>
		<td<?php echo $stations->created_at->CellAttributes() ?>>
<span id="el_stations_created_at" class="control-group">
<span<?php echo $stations->created_at->ViewAttributes() ?>>
<?php echo $stations->created_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($stations->updated_at->Visible) { // updated_at ?>
	<tr id="r_updated_at">
		<td><span id="elh_stations_updated_at"><?php echo $stations->updated_at->FldCaption() ?></span></td>
		<td<?php echo $stations->updated_at->CellAttributes() ?>>
<span id="el_stations_updated_at" class="control-group">
<span<?php echo $stations->updated_at->ViewAttributes() ?>>
<?php echo $stations->updated_at->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
