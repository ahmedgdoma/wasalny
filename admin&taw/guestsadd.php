...
$guests_add = NULL; // Initialize page object first

class cguests_add extends cguests {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "guestsview.php")
...
// Create page object
if (!isset($guests_add)) $guests_add = new cguests_add();

// Page init
$guests_add->Page_Init();

// Page main
$guests_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$guests_add->Page_Render();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var guests_add = new ew_Page("guests_add");
guests_add.PageID = "add"; // Page ID
var EW_PAGE_ID = guests_add.PageID; // For backward compatibility

// Form object
var fguestsadd = new ew_Form("fguestsadd");

// Validate form
fguestsadd.Validate = function() {
...
fguestsadd.Form_CustomValidate = 
...
fguestsadd.ValidateRequired = true;
<?php } else { ?>
fguestsadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
fguestsadd.Lists["x_user_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_username","x_phone","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
fguestsadd.Lists["x_travel_id"] = {"LinkField":"x_id","Ajax":null,"AutoFill":false,"DisplayFields":["x_travel_name","","",""],"ParentFields":[],"FilterFields":[],"Options":[]};
...
<?php $guests_add->ShowPageHeader(); ?>
<?php
$guests_add->ShowMessage();
?>
<form name="fguestsadd" id="fguestsadd" class="ewForm form-horizontal" action="<?php echo ew_CurrentPage() ?>" method="post">
<input type="hidden" name="t" value="guests">
<input type="hidden" name="a_add" id="a_add" value="A">
<table class="ewGrid"><tr><td>
<table id="tbl_guestsadd" class="table table-bordered table-striped">
...
<script type="text/javascript">
fguestsadd.Lists["x_user_id"].Options = <?php echo (is_array($guests->user_id->EditValue)) ? ew_ArrayToJson($guests->user_id->EditValue, 1) : "[]" ?>;
</script>
</span>
...
<script type="text/javascript">
fguestsadd.Lists["x_travel_id"].Options = <?php echo (is_array($guests->travel_id->EditValue)) ? ew_ArrayToJson($guests->travel_id->EditValue, 1) : "[]" ?>;
</script>
</span>
